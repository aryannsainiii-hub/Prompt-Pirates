...
export const SAMPLE_EVALUATION_REPORTS: Record<string, InterviewSession> = {
    ...
    turns: [
      {
        ...
        evaluation: {
          ...
          strengths: [
            'Clear isolation of embedding model versioning mismatch',
            'Awareness of distance metric impact on vector spaces'
          ],
          gaps: [
            'Could mention metadata filtering latency overhead'
          ],
          needsFollowUp: false
        }
      },
      {
        ...
        evaluation: {
          ...
          strengths: [
            'Identified code block boundary preservation',
            'Understood context window fragmentation'
          ],
          gaps: [
            'Did not address recursive character chunking fallback strategies'
          ],
          needsFollowUp: false
        }
      },
      {
        ...
        evaluation: {
          ...
          strengths: [
            'Exact RRF rank scoring formula',
            'Two-stage retrieval and re-ranking architecture'
          ],
          gaps: [],
          needsFollowUp: false
        }
  ...
  'CAND-001': {
    ...
    candidate: CANDIDATE_PROFILES[1],
    ...
    turns: [
      {
        ...
        evaluation: {
          ...
          strengths: [
            'Constrained sampling comprehension',
            'Zod/Pydantic schema validation integration'
          ],
          gaps: [],
          needsFollowUp: false
        }
  ...
  'CAND-002': {
    ...
    candidate: CANDIDATE_PROFILES[2],
  ...
  'CAND-003': {
    ...
    candidate: CANDIDATE_PROFILES[3],
